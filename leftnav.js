...
export default class LeftNav {
  ...
  constructor(element, options = {}) {
    ...
    this.options = Object.assign({
      ...
      classItemFade: 'bx--left-nav-list__item--fade',
      classItemHidden: 'bx--left-nav-list__item--hidden',
      classListHidden: 'bx--left-nav-list--hidden',
      classListTop: 'bx--left-nav-list--top',
    }, options);
  ...
  animateNavSection(selectedNav) {
    ...
    if (leftNavSections.children[0] === selectedNav) selectedNav.classList.add(this.options.classNavSectionTransition + '--50');
    else selectedNav.classList.add(this.options.classNavSectionTransition + '--100');
    selectedNav.setAttribute('data-left-nav-current-section', selectedNavLink.textContent);
    selectedNav.removeAttribute('data-left-nav-section');
  ...
  animateNavList(selectedNavTitle) {
    const currentLeftNavList = this.element.querySelector(this.options.selectorLeftNavList + ':not(.bx--left-nav-list--hidden)');
    ...
    //
    // let counter = 0;
    // let counterIteration = 300 / currentLeftNavItems.length;
    // currentLeftNavItems.forEach(item => {
    //   item.setAttribute('tabIndex', '-1');
    //   setTimeout(() => {
    //     item.classList.add(this.options.classItemFade);
    //     setTimeout(() => {
    //       item.classList.add(this.options.classItemHidden);
    //     }, 100);
    //   }, counter);
    ...
    //   item.classList.remove(this.options.classItemHidden);
  ...
  handleDocumentClick(evt) {
    ...
    // const leftNavSection = this.element.ownerDocument.querySelector(this.options.selectorLeftNavSection);
